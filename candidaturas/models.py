...
class Curso(models.Model):
    ...
    TIPO_CHOICES = [
        ...
        ('tecnico', 'Técnico/Centro de Formação'),
    ]
    ...
    tipo = models.CharField(max_length=20, choices=TIPO_CHOICES, default='universitario')
    preco = models.DecimalField(max_digits=10, decimal_places=2, validators=[MinValueValidator(0)], null=True, blank=True)
