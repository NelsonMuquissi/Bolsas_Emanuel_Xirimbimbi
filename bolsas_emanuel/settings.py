"""
Django settings for bolsas_emanuel project.
...
ROOT_URLCONF = 'bolsas_emanuel.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [ BASE_DIR / 'templates' ],   # se for usar templates globais
        'APP_DIRS': True,
...
WSGI_APPLICATION = 'bolsas_emanuel.wsgi.application'
...
JAZZMIN_SETTINGS = {
    "site_title": "Fundo de Bolsas Emanuel Xirimbimbi",
    "site_header": "Fundo de Bolsas",
    "site_brand": "Fundo de Bolsas",
